...
var _Poll = __webpack_require__(28);
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      fetch('http://localhost:7777/api/polls').then(function (response) {
        response.json().then(function (data) {
          _this2.setState(Object.assign(_this2.state, { polls: data }));
        });
      });
    }
  }, {
    key: 'updateCount',
    value: function updateCount(id, option) {
      var _this3 = this;
      ...
      fetch('http://localhost:7777/api/polls', {
        ...
        response.json().then(function (newdata) {
          _this3.setState(Object.assign(_this3.state, { polls: newdata }));
        });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      var results = [];
      this.state.polls.forEach(function (item) {
        results.push(_react2.default.createElement(_Poll2.default, { poll: item, key: item._id, id: item._id, handleClick: _this4.updateCount }));
      });
...
var Poll = function Poll(props) {
  var options = props.poll.options.map(function (option, i) {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'button',
        { key: 'key is ' + i, onClick: function onClick() {
            return props.handleClick(props.id, i + 1);
          } },
        'Vote'
      )
    );
  ...
  _createClass(Create, [{
    ...
    value: function handleSubmit(event) {
      ...
      fetch('http://localhost:7777/api/create', {
        ...
        response.json().then(function (newdata) {
          _this2.setState(Object.assign(_this2.state, { polls: newdata, fireRedirect: true }));
        });
      });
    }
  }, {
    ...
    value: function handleOptionChange(event, idx) {
      var newOptions = this.state.options.map(function (item, oidx) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.state.options.map(function (item, idx) {
            return _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement('input', {
                ...
                onChange: function onChange(e) {
                  return _this3.handleOptionChange(e, idx);
                },
                key: item
              })
            );
          ...
          _react2.default.createElement(
            'button',
            { type: 'button', onClick: this.handleAddOption },
            'Add another option +'
          ),
          _react2.default.createElement(
            'button',
